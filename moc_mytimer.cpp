...
QT_MOC_LITERAL(3, 21, 15) // "updateTimeLabel"

    },
    "MyTimer\0timeChanged\0\0updateTimeLabel"
};
...
void MyTimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTimer::timeChanged)) {
                *result = 0;
            }
        }
    }
